...
class PublicationTypeDAO implements IPublicationTypeDAO {
  private const SELECT_PUBLICATION_TYPE_BY_ID = "SELECT * FROM publication_type WHERE id = :id";
  private const SELECT_ALL_PUBLICATION_TYPES = "SELECT * FROM publication_type";
  private const INSERT_PUBLICATION_TYPE = "INSERT INTO publication_type (name) VALUES (:name)";
  private const UPDATE_PUBLICATION_TYPE = "UPDATE publication_type SET name = :name WHERE id = :id";
  private const DELETE_PUBLICATION_TYPE = "DELETE FROM publication_type WHERE id = :id";
