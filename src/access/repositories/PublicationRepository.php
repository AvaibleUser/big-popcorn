...
class PublicationRepository implements IPublicationRepository {
  ...
  public function createPublication(Publication $publication): Publication {
    ...
    createPublicationAuthors($publication->id, $publication->authors);
    createPublicationReferences($publication->id, $publication->references);
    return $publication;
  }
  ...
  public function getPublicationById(int $id): ?Publication {
    ...
    return new Publication($row['id'], $row['title'], $row['abstract'], $row['content'], $row['publication_date'], [], [], [], [], new PublicationType($row['ptid'], $row['name']));
  }
  ...
  public function getPublicationReferences(int $id): array {
    ...
    $statement->execute(['id' => $id]);
    return getRecordsFromStatement($statement);
  }
